...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c46 = function() { return { type: "Literal", value: true, loc: location() }; },
      peg$c47 = function() { return { type: "Literal", value: false, loc: location() }; },
      ...
      peg$c244 = function() { return { type: "ThisExpression", loc: location() }; },
      peg$c245 = "(",
      ...
      peg$c383 = function() { return { type: "EmptyStatement", loc: location() }; },
      ...
      peg$c394 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, loc: location() }; },
      peg$c395 = function(test, body) { return { type: "WhileStatement", test: test, body: body, loc: location() }; },
  ...
  function peg$parseFreeStanding() {
    var s0, s1, s2, s3;

    s0 = peg$currPos;
    s1 = peg$parse__();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseSourceUnit();
      if (s2 === peg$FAILED) {
                ...
                if (s8 !== peg$FAILED) {
                  ...
                  if (s9 !== peg$FAILED) {
                    ...
                    if (s10 !== peg$FAILED) {
                      s11 = peg$parse__();
                      if (s11 !== peg$FAILED) {
                        s12 = peg$parseInformalParameterList();
                        if (s12 !== peg$FAILED) {
                          s13 = peg$parse__();
                          if (s13 !== peg$FAILED) {
                            if (input.charCodeAt(peg$currPos) === 41) {
